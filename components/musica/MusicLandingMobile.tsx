...
export function MusicLandingMobile({ player, onOpenPlayer }: MusicLandingMobileProps) {
  ...
  return (
    <div
      className="flex-1 flex flex-col items-center justify-center px-5 pb-28 pt-4 relative bg-gradient-to-b from-cream-100 via-rose-50 to-peach-100"
    >
      <motion.header
      ...
      <motion.button
        ...
        className="mt-10 flex flex-col items-center gap-1 text-warm-600/40 text-xs tracking-widest uppercase"
      >
